...
// $medewerkers = "SELECT passagiernummer from Passagier";
...
//     $query = $vb->prepare($sql);
//     $hashed = password_hash($defaultPassword, PASSWORD_DEFAULT);
//     $query->execute([":wachtwoord" => $hashed, ":pn" => $medewerkernummer]);
// }

$alter = "ALTER table Medewerker ALTER COLUMN wachtwoord varchar(255)";
$vb->query($alter);

$medewerkers = "SELECT medewerkernummer from Passagier";
$data = $vb->query($medewerkers);
